...
osmfilter skopje.osm --keep="amenity=university" | osmconvert - --all-to-nodes --csv="name addr:city addr:street opening_hours phone @lat @lon" --csv-headline --csv-separator="," -o="skopje_universities.csv"
